{{-- resources/views/compras/historial.blade.php --}}
<!DOCTYPE html>
<html lang="es">
<head>
    <meta charset="UTF-8">
    ...
    * { margin: 0; padding: 0; box-sizing: border-box; }
    ...
    .historial-container { max-width: 1200px; margin: 3rem auto; padding: 0 2rem; }
    ...
    .btn { padding: 0.8rem 1.5rem; border-radius: 12px; font-weight: 600; text-decoration: none; display: inline-flex; align-items: center; gap: 8px; transition: var(--transicion); border: none; cursor: pointer; }
    ...
    .filtro-card { background: var(--blanco); padding: 1.5rem 2rem; border-radius: 20px; box-shadow: var(--sombra); margin-bottom: 3rem; display: flex; align-items: flex-end; gap: 1.5rem; flex-wrap: wrap; }
    ...
    .btn-filtrar { background: var(--amarillo-sol); color: var(--oscuro); font-weight: 800; padding: 0.9rem 2rem; border-radius: 12px; border: none; cursor: pointer; }

    .grid-historial { display: flex; flex-direction: column; gap: 1.2rem; }
    .card-compra { background: var(--blanco); border-radius: 20px; overflow: hidden; box-shadow: var(--sombra); border: 1px solid rgba(0,0,0,0.05); display: grid; grid-template-columns: 80px 150px 1fr 150px 180px; align-items: center; transition: var(--transicion); }
    .card-compra:hover { border-color: var(--verde-selva); transform: scale(1.01); }
    .card-compra-header { background: var(--oscuro); color: var(--blanco); height: 100%; display: flex; flex-direction: column; justify-content: center; align-items: center; padding: 1rem 0; }
    ...
    .monto-final { background: #f0fdf4; height: 100%; display: flex; align-items: center; justify-content: center; font-family: 'Montserrat'; font-weight: 800; font-size: 1.2rem; color: var(--verde-oscuro); border-left: 1px solid #e0eee0; padding: 1rem; }
    ...
    <nav>
        ...
        <div class="user-welcome">
            <div class="user-links">
                <a href="/compras/crear"><i class="fa-solid fa-ticket"></i> Comprar</a>
                <a href="/logout" class="logout"><i class="fa-solid fa-door-open"></i> Salir</a>
            </div>
        </div>
    </nav>
</header>
...
<main class="historial-container">
    ...
    <div class="page-header-flex">
        ...
        <h1>Mis Compras</h1>
        <a href="/compras/crear" class="btn btn-comprar-mas">
            <i class="fa-solid fa-cart-plus"></i> Realizar nueva compra
        </a>
    </div>

    <form method="GET" action="/compras/historial" class="filtro-card">
        <div class="campo">
        ...
        @forelse ($compras as $c)
            <div class="card-compra">
                ...
                <div class="detalles-fila">
                    <span><i class="fa-solid fa-calendar"></i> {{ $c['fecha'] }}</span>
                    <span style="color:#888; font-size:0.8rem;">
                        <i class="fa-solid fa-clock"></i> {{ $c['hora'] }}
                    </span>
                </div>
...
<footer>
    ...
    <p>&copy; {{ date('Y') }} Compromiso con la Naturaleza.</p>
</footer>
