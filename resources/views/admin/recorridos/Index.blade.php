                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td class="actions">
                                ...
                                <form method="POST" action="/admin/recorridos/eliminar" style="display:inline"
                                      onsubmit="return confirm('¿Confirma eliminar este recorrido?')">
                                    @csrf
                                    <input type="hidden" name="id" value="{{ $rec->id_recorrido }}">
