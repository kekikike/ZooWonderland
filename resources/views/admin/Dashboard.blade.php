...
<body>
    ...
    <header>
        <nav>
            ...
            <div class="menu">
                ...
                <a href="/admin/recorridos" title="Gestionar Recorridos">
                    <i class="fas fa-route"></i> Recorridos
                </a>
                <a href="/admin/areas" title="Gestionar Áreas">
                    <i class="fas fa-map"></i> Áreas
                </a>
                <a href="/admin/animales" title="Gestionar Animales">
                    <i class="fas fa-paw"></i> Animales
                </a>
                <a href="/admin/reservas" title="Ver Reservas">
                    <i class="fas fa-calendar-alt"></i> Reservas
                </a>
                <a href="/admin/usuarios" title="Gestionar Usuarios">
                    <i class="fas fa-user-group"></i> Usuarios
                </a>
                <a href="/admin/reportes" title="Ver Reportes">
                    <i class="fas fa-file-chart-line"></i> Reportes
                </a>
                <a href="/admin/asignaciones" title="Asignar Guías">
                    <i class="fas fa-user-tie"></i> Asignaciones
                </a>
                <a href="/admin/eventos" title="Gestionar Eventos">
    ...
    <main>
        <div class="page-header">
            ...
            <p>Gestiona ZooWonderland desde aquí • Última actualización: {{ date('d/m/Y H:i') }}</p>
        </div>
        ...
        <div class="stats-grid">
            <div class="stat-card">
                ...
                <div class="stat-value">{{ $totalRecorridos }}</div>
            </div>
            ...
            <div class="stat-card">
                ...
                <div class="stat-value">Bs. {{ number_format($totalIngresos, 0) }}</div>
            </div>

            <div class="stat-card">
                <div class="stat-icon"><i class="fas fa-person-hiking"></i></div>
                <div class="stat-label">Guías</div>
                <div class="stat-value">{{ $totalGuias }}</div>
            </div>
        </div>
        ...
        <div class="content-section">
            ...
            <p class="section-note">Total de recorridos: <strong>{{ $totalRecorridos }}</strong></p>
                ...
                <div class="recorridos-cards">
                    @foreach($recorridos as $rec)
                        <div class="card">
                            <h3>{{ $rec->nombre }}</h3>
                            <p>Tipo: {{ $rec->tipo ?? '—' }}</p>
                            <p>Precio: Bs. {{ number_format($rec->precio ?? 0, 2) }}</p>
                        </div>
                    @endforeach
                </div>
                <div class="section-footer">
                    <a href="/admin/recorridos" class="btn-secondary">Ver tabla completa</a>
                </div>
            @endif
        </div>
    </main>
