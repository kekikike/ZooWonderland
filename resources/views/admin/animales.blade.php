    ...
    <main>
        ...
        <div class="content-section">
            ...
            <div style="margin-bottom: 2rem;">
                <form method="GET" action="/admin/animales" style="display: flex; gap: 0.8rem; align-items: center;">
                ...
                <table>
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td class="actions">
                                <a href="/admin/animales/editar?id={{ $animal->id_animal }}" class="edit" title="Editar">
                                    <i class="fas fa-pen"></i> Editar
                                </a>
                                <a href="/admin/animales/eliminar?id={{ $animal->id_animal }}" class="delete" title="Eliminar"
                                   onclick="return confirm('¿Confirma eliminar este animal?')">
